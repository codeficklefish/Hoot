...
struct RuleBasedClassifier: FileClassifier {
    ...
    func classify(_ file: FileItem, excerpt: String?) -> ClassificationResult {
    ...
    static func typeCategory(for file: FileItem) -> String {
