...
final class OperationHistory {
    private(set) var batches: [OperationBatch] = []
    ...
    func record(_ batch: OperationBatch) {
    ...
    func markUndone(_ batchID: UUID, at date: Date = Date()) {
    ...
    var mostRecentUndoable: OperationBatch? {
