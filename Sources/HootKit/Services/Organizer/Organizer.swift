...
public struct Organizer {
    ...
    public func organize(_ plan: OrganizationPlan) -> (batch: OperationBatch, failures: [(PlannedMove, Error)]) {
    ...
    public func undo(_ batch: OperationBatch) -> (restored: [FileOperation], failures: [(FileOperation, Error)]) {
