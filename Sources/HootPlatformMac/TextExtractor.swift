...
public struct TextExtractor: TextExtracting {
    public init() {}
    ...
    public typealias Evidence = ExtractedEvidence

    private struct _UnusedEvidence {
        let excerpt: String
    ...
    public func evidence(for file: FileItem) -> Evidence? {
