...
public struct AppleOnDeviceProvider: AIProvider {
    ...
    public static let maximumFilesPerRequest = 18
    ...
    public func suggestGrouping(for files: [FileDescriptor]) async throws -> GroupingSuggestion {
...
private struct ModelCategories: Equatable {
    ...
    public let files: [ModelCategory]
}
...
private struct ModelGrouping: Equatable {
    ...
    public let projects: [ModelProject]
